...
import zhongl.stream.netty.Netty._
...
package object netty {
  ...
  trait Transport[C <: DuplexChannel] {
  ...
  implicit def nio(implicit sys: ActorSystem): Transport[NioSocketChannel] = new Transport[NioSocketChannel] {
    ...
    override protected def system = sys
  }
}
